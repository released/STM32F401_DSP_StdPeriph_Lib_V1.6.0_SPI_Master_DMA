...
/* Exported functions ----------------------------------------------- */
unsigned char _AscToHex_(unsigned char aHex);
unsigned char _HexToAsc_(unsigned char aChar);
void _CharToString_(unsigned char value, unsigned char* res);
void _IntToUnicode_ (unsigned long value , unsigned char *pbuf , unsigned char len);
void _floatToInt_(float in, signed long *out_int, signed long *out_dec, signed long dec_prec);
void PrintfToRow16(unsigned long len,unsigned char* array);
